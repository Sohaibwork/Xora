...
const fileUploadRapper = document.querySelector('.file-upload-wrapper');
...
// 
const API_KEY = "AIzaSyBYgE7JnAV5xlgtqRcr8QvFPqg0YqwuAmU";
...
${userData.file.data}"class="attachment" />` : ""}`;
    ...
    setTimeout(() => {
        ...
        const incomingMsgDiv = createMsgElem(messageContent, "bot-message", "thinking");
...
// handle enter ket press for sending message
...
fileInput.addEventListener("change", () => {
    ...
    reader.onload = (e) => {
        fileUploadRapper.querySelector('img').src = e.target.result;
        fileUploadRapper.classList.add("file-uploaded");
...
sendMessageButton.addEventListener('click', (e) => HOGmsg(e));
